...
//     Widget _buildMessageItem(BuildContext context, {required String message, required String sender, required String time, required bool sentByMe, required String gifUrl, required bool isGif}) {
...
//           GestureDetector(
//             onTap: () {
//               if (isGif || _isImage(gifUrl)) {
//                 // Display the image or GIF in a larger view when tapped
//                 print('Tapped on image or GIF: ${gifUrl}'); // Debug log
//                 Navigator.of(context).push(MaterialPageRoute(
//                   builder: (context) {
...
//               padding: const EdgeInsets.symmetric(vertical: 3.0),
//               child: Container(
//                 decoration: BoxDecoration(color:  sentByMe ? Colors.grey.shade100 : Colors.white),
//                 child: Align(
